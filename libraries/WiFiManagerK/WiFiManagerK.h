...
#ifndef WiFiManagerK_h
#define WiFiManagerK_h
...
const char HTTP_PORTAL_OPTIONS[] PROGMEM = "<form action=\"/wifi\" method=\"get\"><button>Configurar WiFi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>Configurar WiFi (Sem busca)</button></form><br/><form action=\"/i\" method=\"get\"><button>Informa&ccedil&otildeoes</button></form><br/><form action=\"/r\" method=\"post\"><button>Reset</button></form>";
...
//const char HTTP_SCAN_LINK[] PROGMEM = "<br/><button type='submit'>Scan</button></form><a href=\"/wifi\">Scan</a></div>";
const char HTTP_SCAN_LINK[] PROGMEM = "<br/><div style=\"text-align: center\"><a href=\"/wifi\">Scan</a></div>";

const char HTTP_SAVED[] PROGMEM = "<div>Wifi Salvo<br />Tentando conectar na rede especificada.<br />Caso a conex&atildeo falhe, tente configura-la novamente</div>";
